...
<body>
	<div class="container">
			<div class="form-row">
				<h1 class="form-title">更改教练信息</h1>
				&nbsp&nbsp&nbsp&nbsp
			<form action="update_coach_info.php" method="POST">
				<div class="form-group">
				<label class="col-sm-2 control-label">会员姓名：</label><input class="form-control required" type="text" placeholder="请输入要更新的会员姓名" id="name" name="name" autofocus="autofocus" maxlength="20" style="width:25%" required="required" />
				</div>
